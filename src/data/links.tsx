...
const blogIsActive = (actualRoute: string, href: string) =>
  actualRoute === '/blog/uses' ? false : actualRoute.includes(href);
...
export const mainRoutes: Links[] = [
  ...
  {
    name: 'CV',
    href: 'https://read.cv/codingcodax',
    isExternal: true,
    isActive,
  },
  {
    icon: (
      <>
        RSS <RSSIcon css={{ ml: '$2', h: '$5', display: 'inline' }} />
      </>
    ),
    href: '/rss/feed.xml',
    isExternal: false,
