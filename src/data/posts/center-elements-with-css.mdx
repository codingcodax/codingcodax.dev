...
category: post
image: https://res.cloudinary.com/codingcodax/image/upload/v1645568881/blog/1/cover.png
---
...
<Img
  ...
  placeholder='blur'
  src={`https://res.cloudinary.com/codingcodax/image/upload/v1616080807/blog/1/Center_horizontally_CSS.jpg`}
  blurDataURL={`https://res.cloudinary.com/codingcodax/image/upload/v1625845369/blog/1/horizontally_blur.jpg`}
>
...
<Img
  ...
  placeholder='blur'
  src={`https://res.cloudinary.com/codingcodax/image/upload/v1616080807/blog/1/Center_vertically_CSS.jpg`}
  blurDataURL={`https://res.cloudinary.com/codingcodax/image/upload/v1625845369/blog/1/vertically_blur.jpg`}
>
...
<Img
  ...
  placeholder='blur'
  src={`https://res.cloudinary.com/codingcodax/image/upload/v1616080807/blog/1/center_both_css.jpg`}
  blurDataURL={`https://res.cloudinary.com/codingcodax/image/upload/v1625845369/blog/1/both_blur.jpg`}
>
